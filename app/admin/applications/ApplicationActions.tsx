    ...
    <div className="flex flex-wrap gap-2">
      ...
      {result && (
        <div className="w-full rounded-xl bg-slate-50 p-3">
          ...
          {result.success && result.whatsappUrl && <a href={result.whatsappUrl} target="_blank" rel="noreferrer" className="mt-2 inline-flex rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-700 hover:bg-emerald-100">Send via WhatsApp</a>}
        </div>
      )}
    </div>
  );
